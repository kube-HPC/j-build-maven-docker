...
# docker run --name archiva --network="host" -p  8080:8080 hkube/empty-archiva:1.0 &
docker run --name archiva --network="host" -p  8080:8080 -v /home/golanha/tempo/archiva-data/:/archiva-data xetusoss/archiva &
sleep 20
...
docker container commit archiva hkube/maven-registry:${VERSION}
